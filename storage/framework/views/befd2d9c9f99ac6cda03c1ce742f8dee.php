            ...
            <div class="w-full max-w-4xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    ...
                    <div class="pr-8 py-6 ml-5">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('random.step.store',['step'=>7])); ?>" method="POST">
                            <?php echo csrf_field(); ?>

                            <div class="grid gap-4">
                                <div>
                                    <input type="hidden" name="advertise6" value="<?php echo e($imagePath); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omatyir/domains/omaty.ir/core/resources/views/random/step6.blade.php ENDPATH**/ ?>