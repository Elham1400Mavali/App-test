            ...
            <div class="w-full max-w-4xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    ...
                    <div class="pr-8 py-6 ml-5">
                        ...
                        <form action="<?php echo e(route('random.step.store',['step'=>4])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omatyir/domains/omaty.ir/core/resources/views/random/step3.blade.php ENDPATH**/ ?>