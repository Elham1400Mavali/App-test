        ...
        <div class="flex  p-2 justify-center">
            <div class="w-full max-w-4xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    <div class="bg-green-400 px-4 py-3 rounded-t-lg text-2xl font-bold text-center">تبلیغات مرحله (5/6)</div>
                    ...
                    <div class="pr-8 py-6 ml-5">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('random.step.store',['step'=>6])); ?>" method="POST">
                            <?php echo csrf_field(); ?>

                            <div class="grid gap-4">
                                <div>
                                    <input type="hidden" name="advertise5" value="<?php echo e($imagePath); ?>">
                                ...
                                <ul class="grid p-3 grid-cols-3 mr-0 md:grid-cols-5 gap-6">
                                    <?php $__currentLoopData = $randomImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div>
                                    <div class="relative">
                                        <input type="text" id="filled_success"  name="comment5" aria-describedby="filled_success_help"
                            ...
                            <button type="submit"
                                    class="relative  top-5 text-white w-full max-w-xl left-4 right-5 bg-gradient-to-br
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omatyir/domains/omaty.ir/core/resources/views/random/step5.blade.php ENDPATH**/ ?>