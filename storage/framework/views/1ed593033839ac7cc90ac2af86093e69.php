            ...
            <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main class="mt-6">
                            <form action="<?php echo e(route('form.step4')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php for($i = 19; $i <= 24; $i++): ?>
                                    <select name="question<?php echo e($i); ?>" required>                                    <option value="" name=""></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/makvandi/projects/survey/resources/views/forms/step4.blade.php ENDPATH**/ ?>