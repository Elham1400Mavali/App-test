<?php $__env->startSection('content'); ?>
    <style>
        ...
        .counter {
            ...
            box-shadow: 0 0 28px 4px rgba(161, 161, 161, 0.22);
            width: 140px;
            height: 140px;
        }
        img, svg {
        ...
        <div class="flex  p-10 justify-center">
            <div class="w-full max-w-3xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    <div class="bg-green-400 px-4 py-3 rounded-t-lg text-2xl font-bold text-center"><?php echo e(__('پرسشنامه جمعیت شناختی')); ?></div>
                    <div class="px-8 py-6 pr-15">
                        <main class="mt-6 mr-7">
                            <form action="<?php echo e(route('survey.form.store',['step' => 1])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="border mb-6 bg-green-50 inline-block ml-2 p-3 w-full-50 items-stretch border-gray-300 rounded-lg">
                                    <label  class="ms-1 text-sm font-medium text-gray-900 dark:text-gray-300">تحصیلات :</label>
                                    <select name="education" class="bg-green-200 p-2 float-left ml-2" required>
                                ...
                                <div class="border mb-6 bg-green-100 inline-block p-3 w-full-50 items-stretch border-gray-300 rounded-lg">
                                    <label  class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">وضعیت تاهل :</label>
                                    <select name="marital_status" class="bg-green-200 p-2 float-left ml-2" required>
                                        <option value="">یک گزینه را انتخاب کنید</option>
                                ...
                                <div class="border mb-6 bg-green-100 inline-block p-3  ml-2 w-full-50 items-stretch
                                    ...
                                    <select name="gender" class="bg-green-200 p-2 float-left ml-2" required>
                                        <option value="">یک گزینه را انتخاب کنید</option>
                                ...
                                <div class="border bg-green-100 mb-6 w-full-50 inline-block  p-3 border-gray-300 rounded-lg">
                                    ...
                                    <select name="income" class="bg-green-200 p-2 float-left ml-2" required>
                                        <option value="">یک گزینه را انتخاب کنید</option>
                                ...
                                <div class="border bg-green-100 mb-6 w-full-60 inline-block ml-2 p-3 border-gray-300 rounded-lg">
                                    ...
                                    <select name="old" class="bg-green-200 float-left ml-2 p-3" required>
                                        <option value="">یک گزینه را انتخاب کنید</option>
                                ...
                                <div class="border bg-green-100 mb-6 w-full-50 inline-block  p-3 border-gray-300 rounded-lg">
                                    ...
                                    class="bg-green-200 float-left ml-2 p-3" placeholder="90210" required />
                                </div>
                                ...
                                <div class="border bg-green-100  mb-6 w-full max-w-lg inline-block p-4 border-gray-300 rounded-lg">
                                    ...
                                    <textarea id="message" rows="4" class="bg-green-200 float-left ml-2 p-3" name="job" placeholder="شغل خود را وارد کنید..."></textarea>
                                </div>
                                <br>
                                <button type="submit"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/makvandi/projects/survey/resources/views/welcome.blade.php ENDPATH**/ ?>