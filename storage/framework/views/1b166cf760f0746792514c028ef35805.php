            ...
            <div class="w-full max-w-4xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    ...
                    <div class="pr-8 py-6 ml-5">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('random.step.store',['step'=>5])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    <div class="relative">
                                        <input type="text" id="filled_success"  name="comment4" aria-describedby="filled_success_help"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omatyir/domains/omaty.ir/core/resources/views/random/step4.blade.php ENDPATH**/ ?>