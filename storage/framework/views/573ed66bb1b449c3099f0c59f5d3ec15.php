<?php $__env->startSection('content'); ?>
    ...
    <div class="counterContainer">
        <svg class="counter">
            <circle cx="50%" cy="50%" r="35" style="stroke-dashoffset: 286px;"></circle>
        </svg>
        <span id="countdown-timer">8</span>
    </div>
        ...
        <div class="flex  justify-center">
            <div class="w-full max-w-3xl ">
                ...
                <div class="bg-green-600 shadow-xl rounded-xl">
                    ...
                    <div class="px-8 py-6 ">
                        <main class="mt-6">
                            <form action="<?php echo e(route('survey.form',['step'=> 8])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omatyir/domains/omaty.ir/core/resources/views/forms/step7.blade.php ENDPATH**/ ?>