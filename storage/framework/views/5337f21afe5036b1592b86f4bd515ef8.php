        ...
        <div class="flex  p-10 justify-center">
            <div class="w-full max-w-3xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    ...
                    <div class="px-8 py-6 ">
                        <main class="mt-6">
                            <form action="<?php echo e(route('survey.form.store',['step'=> 3 ])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="border mb-6  border-gray-300 rounded-lg">
                                    ...
                                    items-stretch border-gray-300 rounded-lg">
                                            ...
                                            <div class="space-y-2 flex items-center bg-green-200 border border-gray-300
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/makvandi/projects/survey/resources/views/forms/step3.blade.php ENDPATH**/ ?>