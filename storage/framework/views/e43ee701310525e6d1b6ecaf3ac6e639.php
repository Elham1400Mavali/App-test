        ...
        <div class="flex justify-center">
            <div class="w-full max-w-3xl ">
                ...
                <div class="bg-green-600 shadow-xl rounded-xl">
                    ...
                    <div class="px-8 py-6 ">
                        <main class="mt-6">
                            <form action="<?php echo e(route('survey.form',['step'=> 3])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omatyir/domains/omaty.ir/core/resources/views/forms/step2.blade.php ENDPATH**/ ?>