        ...
        <div class="flex  p-2 justify-center">
            <div class="w-full max-w-4xl ">
                <div class="bg-green-600 shadow-xl rounded-xl">
                    <div class="bg-green-400 px-4 py-3 rounded-t-lg text-2xl font-bold text-center">تبلیغات مرحله (3/6)</div>
                    ...
                    <div class="pr-8 py-6 ml-5">
                        ...
                        <form action="{{ route('random.step.store',['step'=>4]) }}" method="POST">
                            ...
                            <div class="grid gap-4">
                                <div>
                                    <input type="hidden" name="advertise3" value="{{ $imagePath }}">
                                ...
                                <div>
                                    <div class="relative">
                                        <input type="text" id="filled_success"  name="comment3" aria-describedby="filled_success_help"
